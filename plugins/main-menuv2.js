...
conn.sendHydrated2(m.chat, ucp, cap, sad, sgc, 'ᴍ ʏ ɢ ʀ ᴏ ᴜ ᴘ', 'https://youtube.com/@zykobotz', 'ʏ ᴏ ᴜ ᴛ ᴜ ʙ ᴇ', [[em.getRandom() + 'List Menu', `.listmenu`],
  [em.getRandom() + 'Sewa', `.sewa`],[em.getRandom() + 'Speed', `.speed`]], m)
  }
handler.help = ['menuv2']
handler.tags = ['main']
