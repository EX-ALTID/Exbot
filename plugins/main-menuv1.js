...
️  ❍⃕  𝐈 𝐍 𝐅 𝐎 𝐔 𝐒 𝐄 𝐑
  ...
  `
conn.sendHydrated2(m.chat, cap, wm, oh, 'https://youtu.be/E1Cb97Rb-8U', 's ᴄ ʀ ɪ ᴘ ᴛ', 'https://instagram.com/kabulsaputra21', 'ɪ ɴ s ᴛ ᴀ ɢ ʀ ᴀ ᴍ', [[ emojis + 'All Menu', `.? all`],
  [ emojis + 'List Menu', `.tesm`],[ emojis + ' Credit', `.credit`]], m)
  }
  handler.help = ['menuv1']
handler.tags = ['main']
