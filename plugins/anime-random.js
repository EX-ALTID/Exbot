...
conn.sendButton(m.chat, `_${command}_`.trim(), author, haha.data, [['🔄 NEXT 🔄', `/${command}`]], m)}    
if (command == 'boruto') {
let haha = await conn.getFile(`https://api.zeeoneofc.my.id/api/anime/boruto?apikey=RCo6vEcS`)
conn.sendButton(m.chat, `_${command}_`.trim(), author, haha.data, [['🔄 NEXT 🔄', `/${command}`]], m)}
if (command == 'chiho') {
...
conn.sendButton(m.chat, `_${command}_`.trim(), author, haha.data, [['🔄 NEXT 🔄', `/${command}`]], m)}  
if (command == 'mikasa') {
let haha = await conn.getFile(`https://api.zeeoneofc.my.id/api/anime/mikasa?apikey=RCo6vEcS`)
conn.sendButton(m.chat, `_${command}_`.trim(), author, haha.data, [['🔄 NEXT 🔄', `/${command}`]], m)}  
if (command == 'miku') {
...
conn.sendButton(m.chat, `_${command}_`.trim(), author, haha.data, [['🔄 NEXT 🔄', `/${command}`]], m)} 
if (command == 'naruto') {
let haha = await conn.getFile(`https://api.zeeoneofc.my.id/api/anime/naruto?apikey=RCo6vEcS`)
conn.sendButton(m.chat, `_${command}_`.trim(), author, haha.data, [['🔄 NEXT 🔄', `/${command}`]], m)}    
if (command == 'nezuko') {
