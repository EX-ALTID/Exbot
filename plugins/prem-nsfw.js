...
let handler  = async (m, { conn, command, args, usedPrefix, DevMode, isPrems }) => {
	...
	// ------- OTHER ------
  if (global.db.data.chats[m.chat].nsfw == false && m.isGroup) return conn.sendButton(m.chat, '❗ ᴏᴘᴛɪᴏɴs ɴsғᴡ ᴅɪᴄʜᴀᴛ ɪɴɪ ʙᴇʟᴜᴍ ᴅɪɴʏᴀʟᴀᴋᴀɴ ᴏʟᴇʜ ᴀᴅᴍɪɴ ɢʀᴏᴜᴘ',botdate, null, [['ᴇɴᴀʙʟᴇ', `${usedPrefix}on nsfw`]], m)
...
const sections = [
   {
	title: '◤◢◣◥◤◢◣◥◤◢◣◥◤◢◣◥◤◢◣◥◤◢◣◥◤◢◣◥◤◢◣◥',
	rows: [
	{title: `${(ch == true ? false : ahegao) == true ? p : f}` + "A • Ahegao", rowId: `${usedPrefix}nsfw ahegao`},
	{title: `${(ch == true ? false : anal) == true ? p:f}` + "A • Anal", rowId: `${usedPrefix}nsfw anal`},
	{title: `${(ch == true ? false : ass) == true ? p:f}` + "A • Ass", rowId: `${usedPrefix}nsfw ass`},
	{title: `${(ch == true ? false : blowjob) == true ? p:f}` + "B • BlowJob", rowId: `${usedPrefix}nsfw blowjob`},
	{title: `${(ch == true ? false : cums) == true ? p:f}` + "C • Cumsluts", rowId: `${usedPrefix}nsfw cums`},
	{title: `${(ch == true ? false : ecchi) == true ? p:f}` + "E • Ecchi", rowId: `${usedPrefix}nsfw ecchi`},
	{title: `${(ch == true ? false : ero) == true ? p:f}` + "E • Ero", rowId: `${usedPrefix}nsfw ero`},
  //{title: `${(ch == true ? false : erofeet) == true ? p:f}` + "E • Ero Feet", rowId: `${usedPrefix}nsfw erofeet`},
	{title: `${(ch == true ? false : erogirl) == true ? p:f}` + "E • Ero Girl", rowId: `${usedPrefix}nsfw erogirl`},
	{title: `${(ch == true ? false : holoero) == true ? p:f}` + "E • Ero Holo", rowId: `${usedPrefix}nsfw holoero`},
  //{title: `${(ch == true ? false : erokitsune) == true ? p:f}` + "E • Ero Kitsune", rowId: `${usedPrefix}nsfw erokitsune`},
  //{title: `${(ch == true ? false : eroneko) == true ? p:f}` + "E • Ero Neko", rowId: `${usedPrefix}nsfw eroneko`},
  //{title: `${(ch == true ? false : eroyuri) == true ? p:f}` + "E • Ero Yuri", rowId: `${usedPrefix}nsfw eroyuri`},
	{title: `${(ch == true ? false : feet) == true ? p:f}` + "F • Feet", rowId: `${usedPrefix}nsfw feet`},
	{title: `${(ch == true ? false : femdom) == true ? p:f}` + "F • Femdom", rowId: `${usedPrefix}nsfw femdom`},
	{title: `${(ch == true ? false : futanari) == true ? p:f}` + "F • Futanari", rowId: `${usedPrefix}nsfw futanari`},
  //{title: `${(ch == true ? false : girlsolo) == true ? p:f}` + "G • Girl Solo", rowId: `${usedPrefix}nsfw girlsolo`},
	{title: `${(ch == true ? false : hentai) == true ? p:f}` + "H • Hentai", rowId: `${usedPrefix}nsfw hentai`},
	{title: `${(ch == true ? false : holo) == true ? p:f}` + "H • Holo", rowId: `${usedPrefix}nsfw holo`},
	{title: `${(ch == true ? false : jahy) == true ? p:f}` + "J • Jahy", rowId: `${usedPrefix}nsfw jahy`},
  //{title: `${(ch == true ? false : kitsune) == true ? p:f}` + "K • Kitsune", rowId: `${usedPrefix}nsfw kitsune`},
  //{title: `${(ch == true ? false : kuni) == true ? p:f}` + "K • Kuni", rowId: `${usedPrefix}nsfw kuni`},
	{title: `${(ch == true ? false : loli) == true ? p:f}` + "L • Loli", rowId: `${usedPrefix}nsfw loli`},
	{title: `${(ch == true ? false : manga) == true ? p:f}` + "M • Manga", rowId: `${usedPrefix}nsfw manga`},
	{title: `${(ch == true ? false : milf) == true ? p:f}` + "M • Milf", rowId: `${usedPrefix}nsfw milf`},
	{title: `${(ch == true ? false : mstrb) == true ? p:f}` + "M • Mstrb", rowId: `${usedPrefix}nsfw mstrb`},
	{title: `${(ch == true ? false : neko) == true ? p:f}` + "N • Neko", rowId: `${usedPrefix}nsfw neko`},
	{title: `${(ch == true ? false : oppai) == true ? p:f}` + "O • Oppai", rowId: `${usedPrefix}nsfw oppai`},
	{title: `${(ch == true ? false : panties) == true ? p:f}` + "P • Panties", rowId: `${usedPrefix}nsfw panties`},
	{title: `${(ch == true ? false : pussy) == true ? p:f}` + "P • Pussy", rowId: `${usedPrefix}nsfw pussy`},
  //{title: `${(ch == true ? false : spank) == true ? p:f}` + "S • Spank", rowId: `${usedPrefix}nsfw spank`},
	{title: `${(ch == true ? false : tentacles) == true ? p:f}` + "T • Tentacles", rowId: `${usedPrefix}nsfw tentacles`},
	{title: `${(ch == true ? false : thighs) == true ? p:f}` + "T • Thighs", rowId: `${usedPrefix}nsfw thighs`},
  //{title: `${(ch == true ? false : tits) == true ? p:f}` + "T • Tits", rowId: `${usedPrefix}nsfw tits`},
	{title: `${(ch == true ? false : trap) == true ? p:f}` + "T • Trap", rowId: `${usedPrefix}nsfw trap`},
	{title: `${(ch == true ? false : uniform) == true ? p:f}` + "U • Uniform", rowId: `${usedPrefix}nsfw uniform`},
	{title: `${(ch == true ? false : waifu) == true ? p:f}` + "W • Waifu", rowId: `${usedPrefix}nsfw waifu`},
	{title: `${(ch == true ? false : yaoi) == true ? p:f}` + "Y • Yaoi", rowId: `${usedPrefix}nsfw yaoi`},
	{title: `${(ch == true ? false : yuri) == true ? p:f}` + "Y • Yuri", rowId: `${usedPrefix}nsfw yuri`},
	]
    },
]
...
case 'ahegao':
	    ...
	    if (!isPrems) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', `${usedPrefix}premium`],['ᴏᴡɴᴇʀ', `${usedPrefix}owner nomor`]], m)
		}
...
default:
         return await conn.sendMessage(m.chat, listMessage, { quoted: m, contextInfo: { mentionedJid: [m.sender] }})
           ...
           case '':
               break
default:
          return conn.sendButton( m.chat, caption, fot, null, [`⋮☰ Menu`, `${usedPrefix}menu`], m)
         }
        }
       } catch (err) {
                      m.reply("Error\n\n\n" + err.stack)
